...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPaymentPart();
  });
  ...
  describe('DPPaymentPart', function() {
    it('should create an instance of DPPaymentPart', function() {
      // uncomment below and update the code to test DPPaymentPart
      //var instane = new DirectPortalRestApi.DPPaymentPart();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPaymentPart);
    });
