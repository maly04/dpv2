...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPNotification();
  });
  ...
  describe('DPNotification', function() {
    it('should create an instance of DPNotification', function() {
      // uncomment below and update the code to test DPNotification
      //var instane = new DirectPortalRestApi.DPNotification();
      //expect(instance).to.be.a(DirectPortalRestApi.DPNotification);
    });
