...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPCountry();
  });
  ...
  describe('DPCountry', function() {
    it('should create an instance of DPCountry', function() {
      // uncomment below and update the code to test DPCountry
      //var instane = new DirectPortalRestApi.DPCountry();
      //expect(instance).to.be.a(DirectPortalRestApi.DPCountry);
    });
