...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPContract();
  });
  ...
  describe('DPContract', function() {
    it('should create an instance of DPContract', function() {
      // uncomment below and update the code to test DPContract
      //var instane = new DirectPortalRestApi.DPContract();
      //expect(instance).to.be.a(DirectPortalRestApi.DPContract);
    });

    it('should have the property organizationIssuedToId (base name: "OrganizationIssuedToId")', function() {
      // uncomment below and update the code to test the property organizationIssuedToId
      //var instane = new DirectPortalRestApi.DPContract();
      //expect(instance).to.be();
    });

    it('should have the property organizationIssuedTo (base name: "OrganizationIssuedTo")', function() {
      // uncomment below and update the code to test the property organizationIssuedTo
      //var instane = new DirectPortalRestApi.DPContract();
      //expect(instance).to.be();
    });
