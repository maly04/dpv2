...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPUnitType();
  });
  ...
  describe('DPUnitType', function() {
    it('should create an instance of DPUnitType', function() {
      // uncomment below and update the code to test DPUnitType
      //var instane = new DirectPortalRestApi.DPUnitType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPUnitType);
    });
