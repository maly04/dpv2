...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPContactAddressType();
  });
  ...
  describe('DPContactAddressType', function() {
    it('should create an instance of DPContactAddressType', function() {
      // uncomment below and update the code to test DPContactAddressType
      //var instane = new DirectPortalRestApi.DPContactAddressType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPContactAddressType);
    });
