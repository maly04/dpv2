...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPBuildingPhase();
  });
  ...
  describe('DPBuildingPhase', function() {
    it('should create an instance of DPBuildingPhase', function() {
      // uncomment below and update the code to test DPBuildingPhase
      //var instane = new DirectPortalRestApi.DPBuildingPhase();
      //expect(instance).to.be.a(DirectPortalRestApi.DPBuildingPhase);
    });
