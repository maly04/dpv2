...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPrice();
  });
  ...
  describe('DPPrice', function() {
    it('should create an instance of DPPrice', function() {
      // uncomment below and update the code to test DPPrice
      //var instane = new DirectPortalRestApi.DPPrice();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPrice);
    });
