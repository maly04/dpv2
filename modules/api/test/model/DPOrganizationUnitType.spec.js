...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPOrganizationUnitType();
  });
  ...
  describe('DPOrganizationUnitType', function() {
    it('should create an instance of DPOrganizationUnitType', function() {
      // uncomment below and update the code to test DPOrganizationUnitType
      //var instane = new DirectPortalRestApi.DPOrganizationUnitType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPOrganizationUnitType);
    });
