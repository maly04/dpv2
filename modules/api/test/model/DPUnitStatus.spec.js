...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPUnitStatus();
  });
  ...
  describe('DPUnitStatus', function() {
    it('should create an instance of DPUnitStatus', function() {
      // uncomment below and update the code to test DPUnitStatus
      //var instane = new DirectPortalRestApi.DPUnitStatus();
      //expect(instance).to.be.a(DirectPortalRestApi.DPUnitStatus);
    });
