...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPOrganizationUnitStatus();
  });
  ...
  describe('DPOrganizationUnitStatus', function() {
    it('should create an instance of DPOrganizationUnitStatus', function() {
      // uncomment below and update the code to test DPOrganizationUnitStatus
      //var instane = new DirectPortalRestApi.DPOrganizationUnitStatus();
      //expect(instance).to.be.a(DirectPortalRestApi.DPOrganizationUnitStatus);
    });
