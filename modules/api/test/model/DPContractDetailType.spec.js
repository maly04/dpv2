...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPContractDetailType();
  });
  ...
  describe('DPContractDetailType', function() {
    it('should create an instance of DPContractDetailType', function() {
      // uncomment below and update the code to test DPContractDetailType
      //var instane = new DirectPortalRestApi.DPContractDetailType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPContractDetailType);
    });
