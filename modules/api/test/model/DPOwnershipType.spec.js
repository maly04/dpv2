...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPOwnershipType();
  });
  ...
  describe('DPOwnershipType', function() {
    it('should create an instance of DPOwnershipType', function() {
      // uncomment below and update the code to test DPOwnershipType
      //var instane = new DirectPortalRestApi.DPOwnershipType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPOwnershipType);
    });
