...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPDeveloper();
  });
  ...
  describe('DPDeveloper', function() {
    it('should create an instance of DPDeveloper', function() {
      // uncomment below and update the code to test DPDeveloper
      //var instane = new DirectPortalRestApi.DPDeveloper();
      //expect(instance).to.be.a(DirectPortalRestApi.DPDeveloper);
    });
