...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPDocumentType();
  });
  ...
  describe('DPDocumentType', function() {
    it('should create an instance of DPDocumentType', function() {
      // uncomment below and update the code to test DPDocumentType
      //var instane = new DirectPortalRestApi.DPDocumentType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPDocumentType);
    });
