...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPaymentMethod();
  });
  ...
  describe('DPPaymentMethod', function() {
    it('should create an instance of DPPaymentMethod', function() {
      // uncomment below and update the code to test DPPaymentMethod
      //var instane = new DirectPortalRestApi.DPPaymentMethod();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPaymentMethod);
    });
