...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPSalesRequest();
  });
  ...
  describe('DPSalesRequest', function() {
    it('should create an instance of DPSalesRequest', function() {
      // uncomment below and update the code to test DPSalesRequest
      //var instane = new DirectPortalRestApi.DPSalesRequest();
      //expect(instance).to.be.a(DirectPortalRestApi.DPSalesRequest);
    });
