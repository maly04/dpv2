...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPBuildingStatus();
  });
  ...
  describe('DPBuildingStatus', function() {
    it('should create an instance of DPBuildingStatus', function() {
      // uncomment below and update the code to test DPBuildingStatus
      //var instane = new DirectPortalRestApi.DPBuildingStatus();
      //expect(instance).to.be.a(DirectPortalRestApi.DPBuildingStatus);
    });
