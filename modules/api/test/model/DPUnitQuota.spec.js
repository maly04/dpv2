...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPUnitQuota();
  });
  ...
  describe('DPUnitQuota', function() {
    it('should create an instance of DPUnitQuota', function() {
      // uncomment below and update the code to test DPUnitQuota
      //var instane = new DirectPortalRestApi.DPUnitQuota();
      //expect(instance).to.be.a(DirectPortalRestApi.DPUnitQuota);
    });
