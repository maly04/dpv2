...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPFeature();
  });
  ...
  describe('DPFeature', function() {
    it('should create an instance of DPFeature', function() {
      // uncomment below and update the code to test DPFeature
      //var instane = new DirectPortalRestApi.DPFeature();
      //expect(instance).to.be.a(DirectPortalRestApi.DPFeature);
    });
