...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPSubscription();
  });
  ...
  describe('DPSubscription', function() {
    it('should create an instance of DPSubscription', function() {
      // uncomment below and update the code to test DPSubscription
      //var instane = new DirectPortalRestApi.DPSubscription();
      //expect(instance).to.be.a(DirectPortalRestApi.DPSubscription);
    });
