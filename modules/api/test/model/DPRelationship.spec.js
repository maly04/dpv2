...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPRelationship();
  });
  ...
  describe('DPRelationship', function() {
    it('should create an instance of DPRelationship', function() {
      // uncomment below and update the code to test DPRelationship
      //var instane = new DirectPortalRestApi.DPRelationship();
      //expect(instance).to.be.a(DirectPortalRestApi.DPRelationship);
    });
