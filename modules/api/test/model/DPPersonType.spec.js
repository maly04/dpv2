...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPersonType();
  });
  ...
  describe('DPPersonType', function() {
    it('should create an instance of DPPersonType', function() {
      // uncomment below and update the code to test DPPersonType
      //var instane = new DirectPortalRestApi.DPPersonType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPersonType);
    });
