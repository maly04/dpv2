...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPUnitSubType();
  });
  ...
  describe('DPUnitSubType', function() {
    it('should create an instance of DPUnitSubType', function() {
      // uncomment below and update the code to test DPUnitSubType
      //var instane = new DirectPortalRestApi.DPUnitSubType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPUnitSubType);
    });
