...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPRelationshipType();
  });
  ...
  describe('DPRelationshipType', function() {
    it('should create an instance of DPRelationshipType', function() {
      // uncomment below and update the code to test DPRelationshipType
      //var instane = new DirectPortalRestApi.DPRelationshipType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPRelationshipType);
    });
