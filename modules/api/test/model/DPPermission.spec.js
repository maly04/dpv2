...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPermission();
  });
  ...
  describe('DPPermission', function() {
    it('should create an instance of DPPermission', function() {
      // uncomment below and update the code to test DPPermission
      //var instane = new DirectPortalRestApi.DPPermission();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPermission);
    });
