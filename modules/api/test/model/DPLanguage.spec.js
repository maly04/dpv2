...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPLanguage();
  });
  ...
  describe('DPLanguage', function() {
    it('should create an instance of DPLanguage', function() {
      // uncomment below and update the code to test DPLanguage
      //var instane = new DirectPortalRestApi.DPLanguage();
      //expect(instance).to.be.a(DirectPortalRestApi.DPLanguage);
    });
