...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPRule();
  });
  ...
  describe('DPRule', function() {
    it('should create an instance of DPRule', function() {
      // uncomment below and update the code to test DPRule
      //var instane = new DirectPortalRestApi.DPRule();
      //expect(instance).to.be.a(DirectPortalRestApi.DPRule);
    });
