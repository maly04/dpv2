...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPQuota();
  });
  ...
  describe('DPQuota', function() {
    it('should create an instance of DPQuota', function() {
      // uncomment below and update the code to test DPQuota
      //var instane = new DirectPortalRestApi.DPQuota();
      //expect(instance).to.be.a(DirectPortalRestApi.DPQuota);
    });

    it('should have the property unitQuotas (base name: "UnitQuotas")', function() {
      // uncomment below and update the code to test the property unitQuotas
      //var instane = new DirectPortalRestApi.DPQuota();
