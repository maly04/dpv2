...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPostType();
  });
  ...
  describe('DPPostType', function() {
    it('should create an instance of DPPostType', function() {
      // uncomment below and update the code to test DPPostType
      //var instane = new DirectPortalRestApi.DPPostType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPostType);
    });
