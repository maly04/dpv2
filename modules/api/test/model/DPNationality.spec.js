...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPNationality();
  });
  ...
  describe('DPNationality', function() {
    it('should create an instance of DPNationality', function() {
      // uncomment below and update the code to test DPNationality
      //var instane = new DirectPortalRestApi.DPNationality();
      //expect(instance).to.be.a(DirectPortalRestApi.DPNationality);
    });
