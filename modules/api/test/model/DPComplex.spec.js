...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPComplex();
  });
  ...
  describe('DPComplex', function() {
    it('should create an instance of DPComplex', function() {
      // uncomment below and update the code to test DPComplex
      //var instane = new DirectPortalRestApi.DPComplex();
      //expect(instance).to.be.a(DirectPortalRestApi.DPComplex);
    });
