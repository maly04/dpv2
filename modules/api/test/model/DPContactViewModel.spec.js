...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPContactViewModel();
  });
  ...
  describe('DPContactViewModel', function() {
    it('should create an instance of DPContactViewModel', function() {
      // uncomment below and update the code to test DPContactViewModel
      //var instane = new DirectPortalRestApi.DPContactViewModel();
      //expect(instance).to.be.a(DirectPortalRestApi.DPContactViewModel);
    });
