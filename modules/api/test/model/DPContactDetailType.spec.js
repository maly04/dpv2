...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPContactDetailType();
  });
  ...
  describe('DPContactDetailType', function() {
    it('should create an instance of DPContactDetailType', function() {
      // uncomment below and update the code to test DPContactDetailType
      //var instane = new DirectPortalRestApi.DPContactDetailType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPContactDetailType);
    });
