...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPEntityType();
  });
  ...
  describe('DPEntityType', function() {
    it('should create an instance of DPEntityType', function() {
      // uncomment below and update the code to test DPEntityType
      //var instane = new DirectPortalRestApi.DPEntityType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPEntityType);
    });
