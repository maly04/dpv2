...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPTranslation();
  });
  ...
  describe('DPTranslation', function() {
    it('should create an instance of DPTranslation', function() {
      // uncomment below and update the code to test DPTranslation
      //var instane = new DirectPortalRestApi.DPTranslation();
      //expect(instance).to.be.a(DirectPortalRestApi.DPTranslation);
    });
