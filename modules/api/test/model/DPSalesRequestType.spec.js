...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPSalesRequestType();
  });
  ...
  describe('DPSalesRequestType', function() {
    it('should create an instance of DPSalesRequestType', function() {
      // uncomment below and update the code to test DPSalesRequestType
      //var instane = new DirectPortalRestApi.DPSalesRequestType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPSalesRequestType);
    });
