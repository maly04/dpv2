...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPContactDetail();
  });
  ...
  describe('DPContactDetail', function() {
    it('should create an instance of DPContactDetail', function() {
      // uncomment below and update the code to test DPContactDetail
      //var instane = new DirectPortalRestApi.DPContactDetail();
      //expect(instance).to.be.a(DirectPortalRestApi.DPContactDetail);
    });
