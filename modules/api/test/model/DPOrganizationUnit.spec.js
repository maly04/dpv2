...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPOrganizationUnit();
  });
  ...
  describe('DPOrganizationUnit', function() {
    it('should create an instance of DPOrganizationUnit', function() {
      // uncomment below and update the code to test DPOrganizationUnit
      //var instane = new DirectPortalRestApi.DPOrganizationUnit();
      //expect(instance).to.be.a(DirectPortalRestApi.DPOrganizationUnit);
    });
    ...
    it('should have the property taxIdentification (base name: "TaxIdentification")', function() {
      // uncomment below and update the code to test the property taxIdentification
      //var instane = new DirectPortalRestApi.DPOrganizationUnit();
      //expect(instance).to.be();
    });
