...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPContractDetail();
  });
  ...
  describe('DPContractDetail', function() {
    it('should create an instance of DPContractDetail', function() {
      // uncomment below and update the code to test DPContractDetail
      //var instane = new DirectPortalRestApi.DPContractDetail();
      //expect(instance).to.be.a(DirectPortalRestApi.DPContractDetail);
    });
