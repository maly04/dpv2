...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPFeatureType();
  });
  ...
  describe('DPFeatureType', function() {
    it('should create an instance of DPFeatureType', function() {
      // uncomment below and update the code to test DPFeatureType
      //var instane = new DirectPortalRestApi.DPFeatureType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPFeatureType);
    });
