...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPost();
  });
  ...
  describe('DPPost', function() {
    it('should create an instance of DPPost', function() {
      // uncomment below and update the code to test DPPost
      //var instane = new DirectPortalRestApi.DPPost();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPost);
    });
