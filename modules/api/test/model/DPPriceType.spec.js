...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPriceType();
  });
  ...
  describe('DPPriceType', function() {
    it('should create an instance of DPPriceType', function() {
      // uncomment below and update the code to test DPPriceType
      //var instane = new DirectPortalRestApi.DPPriceType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPriceType);
    });
