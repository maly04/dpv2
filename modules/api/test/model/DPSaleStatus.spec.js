...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPSaleStatus();
  });
  ...
  describe('DPSaleStatus', function() {
    it('should create an instance of DPSaleStatus', function() {
      // uncomment below and update the code to test DPSaleStatus
      //var instane = new DirectPortalRestApi.DPSaleStatus();
      //expect(instance).to.be.a(DirectPortalRestApi.DPSaleStatus);
    });
