...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPersonPrefix();
  });
  ...
  describe('DPPersonPrefix', function() {
    it('should create an instance of DPPersonPrefix', function() {
      // uncomment below and update the code to test DPPersonPrefix
      //var instane = new DirectPortalRestApi.DPPersonPrefix();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPersonPrefix);
    });
