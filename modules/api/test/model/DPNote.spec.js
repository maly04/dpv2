...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPNote();
  });
  ...
  describe('DPNote', function() {
    it('should create an instance of DPNote', function() {
      // uncomment below and update the code to test DPNote
      //var instane = new DirectPortalRestApi.DPNote();
      //expect(instance).to.be.a(DirectPortalRestApi.DPNote);
    });
