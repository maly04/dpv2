...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPaymentType();
  });
  ...
  describe('DPPaymentType', function() {
    it('should create an instance of DPPaymentType', function() {
      // uncomment below and update the code to test DPPaymentType
      //var instane = new DirectPortalRestApi.DPPaymentType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPaymentType);
    });
