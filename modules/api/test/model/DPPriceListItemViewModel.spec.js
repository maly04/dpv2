...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPriceListItemViewModel();
  });
  ...
  describe('DPPriceListItemViewModel', function() {
    it('should create an instance of DPPriceListItemViewModel', function() {
      // uncomment below and update the code to test DPPriceListItemViewModel
      //var instane = new DirectPortalRestApi.DPPriceListItemViewModel();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPriceListItemViewModel);
    });
