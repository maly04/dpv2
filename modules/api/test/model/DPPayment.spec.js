...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPPayment();
  });
  ...
  describe('DPPayment', function() {
    it('should create an instance of DPPayment', function() {
      // uncomment below and update the code to test DPPayment
      //var instane = new DirectPortalRestApi.DPPayment();
      //expect(instance).to.be.a(DirectPortalRestApi.DPPayment);
    });
    ...
    it('should have the property isSpecial (base name: "IsSpecial")', function() {
      // uncomment below and update the code to test the property isSpecial
      //var instane = new DirectPortalRestApi.DPPayment();
      //expect(instance).to.be();
    });
