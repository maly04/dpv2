...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectPortalRestApi.DPReservationType();
  });
  ...
  describe('DPReservationType', function() {
    it('should create an instance of DPReservationType', function() {
      // uncomment below and update the code to test DPReservationType
      //var instane = new DirectPortalRestApi.DPReservationType();
      //expect(instance).to.be.a(DirectPortalRestApi.DPReservationType);
    });
