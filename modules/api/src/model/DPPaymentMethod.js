...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPPaymentMethod = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPPaymentMethod model module.
   * @module model/DPPaymentMethod
   * @version v1
   */

  /**
   * Constructs a new <code>DPPaymentMethod</code>.
   * @alias module:model/DPPaymentMethod
   * @class
   */
  ...
  /**
   * Constructs a <code>DPPaymentMethod</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPPaymentMethod} obj Optional instance to populate.
   * @return {module:model/DPPaymentMethod} The populated <code>DPPaymentMethod</code> instance.
   */
