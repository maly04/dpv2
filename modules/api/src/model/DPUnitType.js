...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPUnitType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPUnitType model module.
   * @module model/DPUnitType
   * @version v1
   */

  /**
   * Constructs a new <code>DPUnitType</code>.
   * @alias module:model/DPUnitType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPUnitType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPUnitType} obj Optional instance to populate.
   * @return {module:model/DPUnitType} The populated <code>DPUnitType</code> instance.
   */
