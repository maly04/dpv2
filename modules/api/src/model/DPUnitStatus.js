...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPUnitStatus = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPUnitStatus model module.
   * @module model/DPUnitStatus
   * @version v1
   */

  /**
   * Constructs a new <code>DPUnitStatus</code>.
   * @alias module:model/DPUnitStatus
   * @class
   */
  ...
  /**
   * Constructs a <code>DPUnitStatus</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPUnitStatus} obj Optional instance to populate.
   * @return {module:model/DPUnitStatus} The populated <code>DPUnitStatus</code> instance.
   */
