...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DPRelationshipType', 'model/DPSubscription'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DPRelationshipType'), require('./DPSubscription'));
  } else {
    // Browser globals (root is window)
    if (!root.DirectPortalRestApi) {
      root.DirectPortalRestApi = {};
    }
    root.DirectPortalRestApi.DPRelationship = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPRelationshipType, root.DirectPortalRestApi.DPSubscription);
  }
}(this, function(ApiClient, DPRelationshipType, DPSubscription) {
  'use strict';
  ...
  /**
   * The DPRelationship model module.
   * @module model/DPRelationship
   * @version v1
   */

  /**
   * Constructs a new <code>DPRelationship</code>.
   * @alias module:model/DPRelationship
   * @class
   * @param targetType {String} 
   */
  var exports = function(targetType) {
    var _this = this;
  ...
  /**
   * Constructs a <code>DPRelationship</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPRelationship} obj Optional instance to populate.
   * @return {module:model/DPRelationship} The populated <code>DPRelationship</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Type')) {
        obj['Type'] = DPRelationshipType.constructFromObject(data['Type']);
      }
  ...
  /**
   * @member {module:model/DPRelationshipType} Type
   */
