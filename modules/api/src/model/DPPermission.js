...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPPermission = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPPermission model module.
   * @module model/DPPermission
   * @version v1
   */

  /**
   * Constructs a new <code>DPPermission</code>.
   * @alias module:model/DPPermission
   * @class
   */
  ...
  /**
   * Constructs a <code>DPPermission</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPPermission} obj Optional instance to populate.
   * @return {module:model/DPPermission} The populated <code>DPPermission</code> instance.
   */
