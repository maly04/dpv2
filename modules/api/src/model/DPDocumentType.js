...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPDocumentType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPDocumentType model module.
   * @module model/DPDocumentType
   * @version v1
   */

  /**
   * Constructs a new <code>DPDocumentType</code>.
   * @alias module:model/DPDocumentType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPDocumentType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPDocumentType} obj Optional instance to populate.
   * @return {module:model/DPDocumentType} The populated <code>DPDocumentType</code> instance.
   */
