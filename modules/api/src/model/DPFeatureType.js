...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPFeatureType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPFeatureType model module.
   * @module model/DPFeatureType
   * @version v1
   */

  /**
   * Constructs a new <code>DPFeatureType</code>.
   * @alias module:model/DPFeatureType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPFeatureType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPFeatureType} obj Optional instance to populate.
   * @return {module:model/DPFeatureType} The populated <code>DPFeatureType</code> instance.
   */
