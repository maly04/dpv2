...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPDeveloper = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPDeveloper model module.
   * @module model/DPDeveloper
   * @version v1
   */

  /**
   * Constructs a new <code>DPDeveloper</code>.
   * @alias module:model/DPDeveloper
   * @class
   */
  ...
  /**
   * Constructs a <code>DPDeveloper</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPDeveloper} obj Optional instance to populate.
   * @return {module:model/DPDeveloper} The populated <code>DPDeveloper</code> instance.
   */
