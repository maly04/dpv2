...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DPSubscription', 'model/DPTranslation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DPSubscription'), require('./DPTranslation'));
  } else {
    // Browser globals (root is window)
    if (!root.DirectPortalRestApi) {
      root.DirectPortalRestApi = {};
    }
    root.DirectPortalRestApi.DPPersonPrefix = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription, root.DirectPortalRestApi.DPTranslation);
  }
}(this, function(ApiClient, DPSubscription, DPTranslation) {
  'use strict';
  ...
  /**
   * The DPPersonPrefix model module.
   * @module model/DPPersonPrefix
   * @version v1
   */

  /**
   * Constructs a new <code>DPPersonPrefix</code>.
   * @alias module:model/DPPersonPrefix
   * @class
   */
  ...
  /**
   * Constructs a <code>DPPersonPrefix</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPPersonPrefix} obj Optional instance to populate.
   * @return {module:model/DPPersonPrefix} The populated <code>DPPersonPrefix</code> instance.
   */
