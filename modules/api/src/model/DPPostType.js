...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPPostType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPPostType model module.
   * @module model/DPPostType
   * @version v1
   */

  /**
   * Constructs a new <code>DPPostType</code>.
   * @alias module:model/DPPostType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPPostType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPPostType} obj Optional instance to populate.
   * @return {module:model/DPPostType} The populated <code>DPPostType</code> instance.
   */
