...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPOrganizationUnitStatus = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPOrganizationUnitStatus model module.
   * @module model/DPOrganizationUnitStatus
   * @version v1
   */

  /**
   * Constructs a new <code>DPOrganizationUnitStatus</code>.
   * @alias module:model/DPOrganizationUnitStatus
   * @class
   */
  ...
  /**
   * Constructs a <code>DPOrganizationUnitStatus</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPOrganizationUnitStatus} obj Optional instance to populate.
   * @return {module:model/DPOrganizationUnitStatus} The populated <code>DPOrganizationUnitStatus</code> instance.
   */
