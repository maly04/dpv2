...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPUnitSubType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPUnitSubType model module.
   * @module model/DPUnitSubType
   * @version v1
   */

  /**
   * Constructs a new <code>DPUnitSubType</code>.
   * @alias module:model/DPUnitSubType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPUnitSubType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPUnitSubType} obj Optional instance to populate.
   * @return {module:model/DPUnitSubType} The populated <code>DPUnitSubType</code> instance.
   */
