...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPSubscription = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPSubscription model module.
   * @module model/DPSubscription
   * @version v1
   */

  /**
   * Constructs a new <code>DPSubscription</code>.
   * @alias module:model/DPSubscription
   * @class
   * @param aPIKey {String} 
   */
  ...
  /**
   * Constructs a <code>DPSubscription</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPSubscription} obj Optional instance to populate.
   * @return {module:model/DPSubscription} The populated <code>DPSubscription</code> instance.
   */
