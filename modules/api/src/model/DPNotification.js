...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPNotification = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPNotification model module.
   * @module model/DPNotification
   * @version v1
   */

  /**
   * Constructs a new <code>DPNotification</code>.
   * @alias module:model/DPNotification
   * @class
   */
  ...
  /**
   * Constructs a <code>DPNotification</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPNotification} obj Optional instance to populate.
   * @return {module:model/DPNotification} The populated <code>DPNotification</code> instance.
   */
