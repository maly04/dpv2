...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPContactViewModel = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPContactViewModel model module.
   * @module model/DPContactViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>DPContactViewModel</code>.
   * @alias module:model/DPContactViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>DPContactViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPContactViewModel} obj Optional instance to populate.
   * @return {module:model/DPContactViewModel} The populated <code>DPContactViewModel</code> instance.
   */
