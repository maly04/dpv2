...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPEntityType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPEntityType model module.
   * @module model/DPEntityType
   * @version v1
   */

  /**
   * Constructs a new <code>DPEntityType</code>.
   * @alias module:model/DPEntityType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPEntityType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPEntityType} obj Optional instance to populate.
   * @return {module:model/DPEntityType} The populated <code>DPEntityType</code> instance.
   */
