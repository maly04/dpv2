...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPReservationType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPReservationType model module.
   * @module model/DPReservationType
   * @version v1
   */

  /**
   * Constructs a new <code>DPReservationType</code>.
   * @alias module:model/DPReservationType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPReservationType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPReservationType} obj Optional instance to populate.
   * @return {module:model/DPReservationType} The populated <code>DPReservationType</code> instance.
   */
