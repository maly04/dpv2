...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPOrganizationUnitType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPOrganizationUnitType model module.
   * @module model/DPOrganizationUnitType
   * @version v1
   */

  /**
   * Constructs a new <code>DPOrganizationUnitType</code>.
   * @alias module:model/DPOrganizationUnitType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPOrganizationUnitType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPOrganizationUnitType} obj Optional instance to populate.
   * @return {module:model/DPOrganizationUnitType} The populated <code>DPOrganizationUnitType</code> instance.
   */
