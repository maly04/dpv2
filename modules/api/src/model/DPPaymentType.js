...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPPaymentType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPPaymentType model module.
   * @module model/DPPaymentType
   * @version v1
   */

  /**
   * Constructs a new <code>DPPaymentType</code>.
   * @alias module:model/DPPaymentType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPPaymentType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPPaymentType} obj Optional instance to populate.
   * @return {module:model/DPPaymentType} The populated <code>DPPaymentType</code> instance.
   */
