...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPOwnershipType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPOwnershipType model module.
   * @module model/DPOwnershipType
   * @version v1
   */

  /**
   * Constructs a new <code>DPOwnershipType</code>.
   * @alias module:model/DPOwnershipType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPOwnershipType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPOwnershipType} obj Optional instance to populate.
   * @return {module:model/DPOwnershipType} The populated <code>DPOwnershipType</code> instance.
   */
