...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPBuildingStatusType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPBuildingStatusType model module.
   * @module model/DPBuildingStatusType
   * @version v1
   */

  /**
   * Constructs a new <code>DPBuildingStatusType</code>.
   * @alias module:model/DPBuildingStatusType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPBuildingStatusType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPBuildingStatusType} obj Optional instance to populate.
   * @return {module:model/DPBuildingStatusType} The populated <code>DPBuildingStatusType</code> instance.
   */
