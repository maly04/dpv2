...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPContactDetailType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPContactDetailType model module.
   * @module model/DPContactDetailType
   * @version v1
   */

  /**
   * Constructs a new <code>DPContactDetailType</code>.
   * @alias module:model/DPContactDetailType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPContactDetailType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPContactDetailType} obj Optional instance to populate.
   * @return {module:model/DPContactDetailType} The populated <code>DPContactDetailType</code> instance.
   */
