...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPSalesRequestType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPSalesRequestType model module.
   * @module model/DPSalesRequestType
   * @version v1
   */

  /**
   * Constructs a new <code>DPSalesRequestType</code>.
   * @alias module:model/DPSalesRequestType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPSalesRequestType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPSalesRequestType} obj Optional instance to populate.
   * @return {module:model/DPSalesRequestType} The populated <code>DPSalesRequestType</code> instance.
   */
