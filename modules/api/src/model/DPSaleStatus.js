...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPSaleStatus = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPSaleStatus model module.
   * @module model/DPSaleStatus
   * @version v1
   */

  /**
   * Constructs a new <code>DPSaleStatus</code>.
   * @alias module:model/DPSaleStatus
   * @class
   */
  ...
  /**
   * Constructs a <code>DPSaleStatus</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPSaleStatus} obj Optional instance to populate.
   * @return {module:model/DPSaleStatus} The populated <code>DPSaleStatus</code> instance.
   */
