...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPBuildingStatus = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPBuildingStatus model module.
   * @module model/DPBuildingStatus
   * @version v1
   */

  /**
   * Constructs a new <code>DPBuildingStatus</code>.
   * @alias module:model/DPBuildingStatus
   * @class
   */
  ...
  /**
   * Constructs a <code>DPBuildingStatus</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPBuildingStatus} obj Optional instance to populate.
   * @return {module:model/DPBuildingStatus} The populated <code>DPBuildingStatus</code> instance.
   */
