...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPContractDetailType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPContractDetailType model module.
   * @module model/DPContractDetailType
   * @version v1
   */

  /**
   * Constructs a new <code>DPContractDetailType</code>.
   * @alias module:model/DPContractDetailType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPContractDetailType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPContractDetailType} obj Optional instance to populate.
   * @return {module:model/DPContractDetailType} The populated <code>DPContractDetailType</code> instance.
   */
