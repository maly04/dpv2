...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DPDocumentType', 'model/DPSubscription'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DPDocumentType'), require('./DPSubscription'));
  } else {
    // Browser globals (root is window)
    if (!root.DirectPortalRestApi) {
      root.DirectPortalRestApi = {};
    }
    root.DirectPortalRestApi.DPDocument = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPDocumentType, root.DirectPortalRestApi.DPSubscription);
  }
}(this, function(ApiClient, DPDocumentType, DPSubscription) {
  'use strict';
  ...
  /**
   * The DPDocument model module.
   * @module model/DPDocument
   * @version v1
   */

  /**
   * Constructs a new <code>DPDocument</code>.
   * @alias module:model/DPDocument
   * @class
   */
  ...
  /**
   * Constructs a <code>DPDocument</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPDocument} obj Optional instance to populate.
   * @return {module:model/DPDocument} The populated <code>DPDocument</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Type')) {
        obj['Type'] = DPDocumentType.constructFromObject(data['Type']);
      }
  ...
  /**
   * @member {module:model/DPDocumentType} Type
   */
