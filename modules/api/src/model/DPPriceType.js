...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPPriceType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPPriceType model module.
   * @module model/DPPriceType
   * @version v1
   */

  /**
   * Constructs a new <code>DPPriceType</code>.
   * @alias module:model/DPPriceType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPPriceType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPPriceType} obj Optional instance to populate.
   * @return {module:model/DPPriceType} The populated <code>DPPriceType</code> instance.
   */
