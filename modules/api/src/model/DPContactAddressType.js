...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPContactAddressType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPContactAddressType model module.
   * @module model/DPContactAddressType
   * @version v1
   */

  /**
   * Constructs a new <code>DPContactAddressType</code>.
   * @alias module:model/DPContactAddressType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPContactAddressType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPContactAddressType} obj Optional instance to populate.
   * @return {module:model/DPContactAddressType} The populated <code>DPContactAddressType</code> instance.
   */
