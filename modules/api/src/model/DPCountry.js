...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPCountry = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPCountry model module.
   * @module model/DPCountry
   * @version v1
   */

  /**
   * Constructs a new <code>DPCountry</code>.
   * @alias module:model/DPCountry
   * @class
   */
  ...
  /**
   * Constructs a <code>DPCountry</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPCountry} obj Optional instance to populate.
   * @return {module:model/DPCountry} The populated <code>DPCountry</code> instance.
   */
