...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPApproval = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPApproval model module.
   * @module model/DPApproval
   * @version v1
   */

  /**
   * Constructs a new <code>DPApproval</code>.
   * @alias module:model/DPApproval
   * @class
   */
  ...
  /**
   * Constructs a <code>DPApproval</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPApproval} obj Optional instance to populate.
   * @return {module:model/DPApproval} The populated <code>DPApproval</code> instance.
   */
