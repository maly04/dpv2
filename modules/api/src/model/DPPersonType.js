...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPPersonType = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription);
  }
  ...
  /**
   * The DPPersonType model module.
   * @module model/DPPersonType
   * @version v1
   */

  /**
   * Constructs a new <code>DPPersonType</code>.
   * @alias module:model/DPPersonType
   * @class
   */
  ...
  /**
   * Constructs a <code>DPPersonType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPPersonType} obj Optional instance to populate.
   * @return {module:model/DPPersonType} The populated <code>DPPersonType</code> instance.
   */
