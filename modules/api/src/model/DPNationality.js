...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DirectPortalRestApi.DPNationality = factory(root.DirectPortalRestApi.ApiClient, root.DirectPortalRestApi.DPSubscription, root.DirectPortalRestApi.DPTranslation);
  }
  ...
  /**
   * The DPNationality model module.
   * @module model/DPNationality
   * @version v1
   */

  /**
   * Constructs a new <code>DPNationality</code>.
   * @alias module:model/DPNationality
   * @class
   */
  ...
  /**
   * Constructs a <code>DPNationality</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DPNationality} obj Optional instance to populate.
   * @return {module:model/DPNationality} The populated <code>DPNationality</code> instance.
   */
