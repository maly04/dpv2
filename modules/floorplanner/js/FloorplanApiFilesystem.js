...
* Attached to a specific instance of Floorplan (via constructor); can be assigned to Floorplan.FloorplanApiFilesystem
...
*   }
*/
function FloorplanApiFilesystem(floorplan, state) {
...
Object.defineProperty(FloorplanApiFilesystem.prototype, "floorplan", {
    get: function () { return this._floorplan; }
});

// Get constant name for an unsaved Floorplan 
Object.defineProperty(FloorplanApiFilesystem.prototype, "UNSAVED_FILENAME", {
...
Object.defineProperty(FloorplanApiFilesystem.prototype, "DEFAULT_MODELDATA", {
    get: function () { return this._DEFAULT_MODELDATA; }
});

// Get state information about this app's UI
Object.defineProperty(FloorplanApiFilesystem.prototype, "state", {
...
FloorplanApiFilesystem.prototype.newFloorplan = function () {
...
FloorplanApiFilesystem.prototype.saveFloorplan = function () {
...
FloorplanApiFilesystem.prototype.saveFloorplanAs = function () {
    var saveName = this.getCurrentFileName();
...
FloorplanApiFilesystem.prototype.loadFloorplan = function () {
    var floorplan = this.floorplan;
...
FloorplanApiFilesystem.prototype.loadFloorplanFromModel = function (str) {
    var floorplan = this.floorplan;
...
FloorplanApiFilesystem.prototype.removeFloorplan = function () {
    var floorplan = this.floorplan;
...
FloorplanApiFilesystem.prototype.showOpenWindow = function () {
    if (checkLocalStorage()) {
...
FloorplanApiFilesystem.prototype.showRemoveWindow = function () {
    if (checkLocalStorage()) {
...
FloorplanApiFilesystem.prototype.setCurrentFileName = function (name) {
...
FloorplanApiFilesystem.prototype.getCurrentFileName = function () {
    var currentFile = document.getElementById(this.state.currentFileId);
