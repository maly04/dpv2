...
if ($('.ct-chart-unit').length) {
  (function () {
    ...
    new Chartist.Pie('.ct-chart-unit-1', data, {
      startAngle: 270,
      donut: true,
      donutWidth: 20,
 	...
 	new Chartist.Pie('.ct-chart-unit-2', data, {
      labelInterpolationFnc: function labelInterpolationFnc(value) {
        return Math.round(value / data.series.reduce(sum) * 100) + '%';
      },
      startAngle: 270,
 	...
 	new Chartist.Pie('.ct-chart-unit-3', data, {
      labelInterpolationFnc: function labelInterpolationFnc(value) {
        return Math.round(value / data.series.reduce(sum) * 100) + '%';
      },
      startAngle: 270,
    ...
    new Chartist.Pie('.ct-chart-unit-4', data, {
      labelInterpolationFnc: function labelInterpolationFnc(value) {
        return Math.round(value / data.series.reduce(sum) * 100) + '%';
      },
      startAngle: 270,
    ...
    new Chartist.Pie('.ct-chart-visitor-walk-in', data, {
      labelInterpolationFnc: function labelInterpolationFnc(value) {
        return Math.round(value / data.series.reduce(sum) * 100) + '%';
      },
      startAngle: 270,
    ...
    new Chartist.Pie('.ct-chart-visitor-call-in', data, {
      labelInterpolationFnc: function labelInterpolationFnc(value) {
        return Math.round(value / data.series.reduce(sum) * 100) + '%';
      },
      startAngle: 270,
    ...
    new Chartist.Pie('.ct-chart-percent-sold', data, {
      labelInterpolationFnc: function labelInterpolationFnc(value) {
        return Math.round(value / data.series.reduce(sum) * 100) + '%';
      },
      startAngle: 270,
    ...
    new Chartist.Pie('.ct-chart-budget', data, {
      labelInterpolationFnc: function labelInterpolationFnc(value) {
        return Math.round(value / data.series.reduce(sum) * 100) + '%';
      },
      startAngle: 270,
